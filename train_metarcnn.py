    ...
    if args.dataset == "coco2017":
        ...
        if args.phase == 1: # three types of base and novel classes splits
            if args.meta_type == 1:
                ...
                args.imdb_name = "voc_2007_train_second_split"
            elif args.meta_type == 3:
                args.imdb_name = "voc_2007_train_third_split"
        else:
            args.imdb_name = "voc_2007_shots" # the default sampled shots  saved path of meta classes in the first phase
        args.imdbval_name = "voc_2007_test"
        args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20', 'RESNET.FIXED_BLOCKS', '1']
    ...
    for epoch in range(args.start_epoch, args.max_epochs):
        ...
        if args.meta_train:
            save_name = os.path.join(output_dir,
                                     '{}_{}_{}_{}_{}.pth'.format(str(args.dataset), str(args.net), 1, epoch,
                                                                 step))
        else:
